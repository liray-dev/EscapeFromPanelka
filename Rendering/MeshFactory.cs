...
public static class MeshFactory
{
    ...
    public static (float[] Vertices, uint[] Indices, PrimitiveType PrimitiveType) CreateCube()
    {
        var vertices = new[]
        {
            -0.5f, 0f, 0.5f,   0f, 0f, 1f,   0.78f, 0.51f, 0.22f,
             0.5f, 0f, 0.5f,   0f, 0f, 1f,   0.78f, 0.51f, 0.22f,
             0.5f, 1f, 0.5f,   0f, 0f, 1f,   0.90f, 0.64f, 0.31f,
            -0.5f, 1f, 0.5f,   0f, 0f, 1f,   0.90f, 0.64f, 0.31f,
            
            -0.5f, 0f, -0.5f,  0f, 0f, -1f,  0.71f, 0.45f, 0.18f,
             0.5f, 0f, -0.5f,  0f, 0f, -1f,  0.71f, 0.45f, 0.18f,
             0.5f, 1f, -0.5f,  0f, 0f, -1f,  0.82f, 0.55f, 0.24f,
            -0.5f, 1f, -0.5f,  0f, 0f, -1f,  0.82f, 0.55f, 0.24f,
            
            -0.5f, 0f, -0.5f, -1f, 0f, 0f,   0.66f, 0.41f, 0.17f,
            -0.5f, 0f, 0.5f,  -1f, 0f, 0f,   0.66f, 0.41f, 0.17f,
            -0.5f, 1f, 0.5f,  -1f, 0f, 0f,   0.77f, 0.51f, 0.23f,
            -0.5f, 1f, -0.5f, -1f, 0f, 0f,   0.77f, 0.51f, 0.23f,

             0.5f, 0f, -0.5f,  1f, 0f, 0f,   0.68f, 0.43f, 0.18f,
             0.5f, 0f, 0.5f,   1f, 0f, 0f,   0.68f, 0.43f, 0.18f,
             0.5f, 1f, 0.5f,   1f, 0f, 0f,   0.80f, 0.56f, 0.25f,
             0.5f, 1f, -0.5f,  1f, 0f, 0f,   0.80f, 0.56f, 0.25f,
             
            -0.5f, 1f, -0.5f,  0f, 1f, 0f,   0.93f, 0.76f, 0.41f,
             0.5f, 1f, -0.5f,  0f, 1f, 0f,   0.93f, 0.76f, 0.41f,
             0.5f, 1f, 0.5f,   0f, 1f, 0f,   0.98f, 0.84f, 0.48f,
            -0.5f, 1f, 0.5f,   0f, 1f, 0f,   0.98f, 0.84f, 0.48f,
            
            -0.5f, 0f, -0.5f,  0f, -1f, 0f,  0.57f, 0.36f, 0.15f,
             0.5f, 0f, -0.5f,  0f, -1f, 0f,  0.57f, 0.36f, 0.15f,
             0.5f, 0f, 0.5f,   0f, -1f, 0f,  0.57f, 0.36f, 0.15f,
            -0.5f, 0f, 0.5f,   0f, -1f, 0f,  0.57f, 0.36f, 0.15f
        };
    ...
    public static (float[] Vertices, uint[] Indices, PrimitiveType PrimitiveType) CreateGrid(int halfExtent, float step, float y)
    {
