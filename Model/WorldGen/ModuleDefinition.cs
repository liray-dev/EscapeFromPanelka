...
public sealed class ModuleDefinition
{
    ...
    public float LootSpawnChance { get; set; } = 0.55f;
    public int MaxLootPerModule { get; set; } = 2;
    public float HostileSpawnChance { get; set; } = 0.0f;
    public int MaxHostilesPerModule { get; set; } = 1;
    public float InfectedZoneChance { get; set; } = 0.0f;
